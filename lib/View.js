...
var _LineComponent = require("./LineComponent");
...
var _SentenceBuilder = require("./SentenceBuilder");
    ...
    _createClass(View, [{
        ...
        value: function render() {
            ...
            var renderLine = listSentence.map(function (item, index) {
                return _react2.default.createElement(_LineComponent2.default, { settings: _this2.props.settings, key: index, index: index, line: item });
            });
