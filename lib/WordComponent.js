        ...
        value: function render() {
            ...
            var renderForm = this.state.data.words.map(function (item, index) {
                ...
                return _react2.default.createElement(
                    'div',
                    { key: index, className: 'item-cat' },
                    renderPos,
                    _react2.default.createElement(
                        'div',
                        { className: 'form', style: { backgroundColor: item.bgColorForm } },
                        item.form
                    )
                );
            });
            ...
            if (this.state.data.ne && this.props.settings.ne) {
                renderNe = _react2.default.createElement(
                    'div',
                    { className: 'word-ne cursor-pointer',
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'padding-word-wrapper' },
                    _react2.default.createElement(
                        'div',
                        { className: 'padding-word' },
                        renderNe,
                        renderWiki
                    )
                ),
